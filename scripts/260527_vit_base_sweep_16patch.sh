#!/bin/bash
#SBATCH -J vit_base_sweep_p16
#SBATCH -o /home/mingyeong/GAL2DM_ASIM_ViT/logs/vit_base_sweep_p16.%A_%a.out
#SBATCH -e /home/mingyeong/GAL2DM_ASIM_ViT/logs/vit_base_sweep_p16.%A_%a.err
#SBATCH -p h100
