#!/bin/bash
#SBATCH -J vitunet3d_ps8_e50_single_ch2
#SBATCH -o logs/icase-ch2/vitunet3d_ps8_e50_single_ch2.%j.out
#SBATCH -e logs/icase-ch2/vitunet3d_ps8_e50_single_ch2.%j.err
#SBATCH -p gpu
#SBATCH --gres=gpu:1
...
srun python -u -m src.train \
  ...
  2>&1 | tee -a "${LOG_DIR}/vitunet3d_ps8_e50_single_ch2_${SLURM_JOB_ID}.console.log"
